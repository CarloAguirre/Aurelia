...
import {
  ...
  OfflineBanner,
  SelectBox,
} from '../../shared/components/form/ManualFormUi';
...
export function InspectionManualIdentificationScreen() {
  function cancel() {
        ...
        <View style={styles.screen}>
          ...
          <ScrollView style={styles.content} contentContainerStyle={styles.contentInner} showsVerticalScrollIndicator={false}>
            <View>
              ...
              <Text style={styles.subtitle}>Completa los datos del inspector y de la inspección antes de continuar</Text>
            </View>

            <FormCard
              icon={<FontAwesome5 name="user-tag" size={11} color={colors.blueLink} />}
              title="Datos del inspector"
              subtitle="¿Quién está realizando esta inspección?"
            >
              <LabeledField label="Inspector *">
                <FieldBox value="Karen Opazo S." />
              </LabeledField>
              <LabeledField label="Empresa del inspector *">
                <FieldBox value="Gold Fields" />
              </LabeledField>
            </FormCard>

            <FormCard
              icon={<FontAwesome5 name="map-marked-alt" size={11} color={colors.teal} />}
              title="Datos de la inspección"
              subtitle="¿Dónde y cuándo se realiza esta inspección?"
            >
              <View style={styles.twoColumns}>
                <View style={styles.column}>
                  <LabeledField label="Área *">
                    <SelectBox value="-Seleccionar-" />
                  </LabeledField>
                </View>
                <View style={styles.column}>
              ...
              <LabeledField label="Fecha de inspección *">
                <FieldBox
                  value="10/06/2026"
                  variant="input"
                  right={<FontAwesome5 name="calendar-alt" size={16} color={colors.primary} />}
                />
              </LabeledField>
              ...
              <View style={styles.locationHeader}>
                ...
                <TouchableOpacity style={styles.infoButton} activeOpacity={0.7}>
                  <FontAwesome5 name="info" size={13} color={colors.blueLink} />
                </TouchableOpacity>
              </View>

              <TouchableOpacity style={styles.locationButton} activeOpacity={0.8}>
                <FontAwesome5 name="check-circle" size={14} color={colors.white} />
                <Text style={styles.locationButtonText}>Ubicación capturada</Text>
              </TouchableOpacity>

              <FieldBox value="19H 351376E 6295754N ± 12.4 m" variant="input" />
              <LocationMapPreview />

              <View style={styles.hintRow}>
                <FontAwesome5 name="hand-point-up" size={11} color={colors.blueLink} />
                <Text style={styles.hintText}>Arrastra el pin para ajustar la ubicación manualmente</Text>
              </View>
            </FormCard>
          </ScrollView>
