...
function InspectionCard({ inspection, index }: { inspection: InspectionResponse; index: number }) {
  ...
  const top = tonePalette[tone].line;
        ...
        <View style={styles.cardTop}>
          ...
          <View style={styles.pills}>
            <View style={styles.pillBlue}>
              ...
              <Text style={styles.pillBlueText}>Inspeccion</Text>
            </View>
    ...
    <View style={styles.drafts}>
      <View style={styles.draftHeader}>
        <View>
          ...
          <Text style={styles.draftSub}>Continua donde lo dejaste - guardados localmente</Text>
        </View>
...
export function InspectionsHomeFigmaScreen() {
  ...
  const draftTitle = `${draftTypeName ?? 'Inspeccion'} - ${draftAreaName ?? 'Sin area'}`;
        ...
        <View style={styles.screen}>
          <View style={styles.header}>
            ...
            <View style={styles.role}>
              ...
              <Text style={styles.roleText}>{user?.role ?? 'Inspector'} - Admin GF HSE</Text>
            </View>
          </View>
          ...
          <View style={styles.actions}>
            ...
            <TouchableOpacity style={styles.newButton} onPress={() => router.push('/inspection/start')}>
              ...
              <Text style={styles.newText}> Nueva inspeccion</Text>
            </TouchableOpacity>
          </View>
          <ScrollView style={styles.list} contentContainerStyle={styles.listContent} showsVerticalScrollIndicator={false}>
            {hasDraft ? <DraftBox title={draftTitle} detail={draftDetail} progress={draftProgress} /> : null}
            {isLoading ? (
              <StateCard loading title="Cargando inspecciones" detail="Estamos obteniendo el resumen y el listado desde la API." />
            ) : isError ? (
              <StateCard title="No se pudo cargar la gestion" detail="Revisa la conexion con la API o vuelve a intentar." action="Reintentar" onPress={refetch} />
            ) : inspections.length === 0 ? (
              <StateCard title="Sin inspecciones registradas" detail="Cuando se creen inspecciones desde terreno apareceran en esta lista." action="Nueva inspeccion" onPress={() => router.push('/inspection/start')} />
            ) : (
          ...
          <View style={styles.tabs}>
            <View style={styles.tabActive}>
              ...
              <Text style={styles.tabActiveText}>Gestion de inspecciones</Text>
...
const inspectionStatusLabel: Record<InspectionStatus, string> = {
  ...
  [InspectionStatus.UNDER_REVIEW]: 'En revision',
