...
const styles = StyleSheet.create({
  ...
  tabs: { height: 70, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around', overflow: 'hidden' },
  tabActive: { alignItems: 'center', justifyContent: 'center', flex: 1 },
  tabCount: { minWidth: 22, height: 22, borderRadius: 11, backgroundColor: colors.gold, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 6 },
  tabCountText: { color: colors.white, fontSize: 11, fontWeight: fontWeight.bold },
  tabActiveText: { marginTop: 4, color: colors.gold, fontSize: 10, fontWeight: fontWeight.bold },
  tabLine: { marginTop: 5, width: 52, height: 3, borderRadius: 3, backgroundColor: colors.gold },
  tabInactive: { alignItems: 'center', flex: 1 },
  tabDot: { width: 10, height: 10, borderRadius: 5, backgroundColor: 'rgba(255,255,255,0.45)', marginTop: 9 },
  tabText: { marginTop: 8, color: 'rgba(255,255,255,0.62)', fontSize: 10 },
});
