...
function SlaBox({ severity }: { severity?: SeverityChoice }) {
  ...
  return <div className="mt-[12px] flex min-h-[64px] w-full items-center justify-between rounded-[10px] border-[1.5px] border-[#E8A06A] bg-[#FFE1CD] p-[15.5px]"><div><p className="text-[9px] font-bold uppercase leading-none tracking-[0.63px] text-[#333]">SLA calculado</p><p className="mt-[2px] text-[20px] font-bold leading-[20px] text-[#333]">{severity.closureTimeLabel}</p></div><button type="button" className="h-[40px] rounded-[8px] border-[1.5px] border-[#D1D1D1] bg-white px-[15.5px] text-[13px] font-semibold text-[#333]">Reasignar SLA</button></div>;
}
