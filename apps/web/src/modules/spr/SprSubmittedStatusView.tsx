...
// Vista post-envio del formulario SPR (Figma 1666:2149 / 1672:5810 / 1672:8557 / 1672:10996).
  ...
  return (
    <div className="h-[calc(100vh-56px)] w-full overflow-y-auto bg-[#f7f7f7]">
      <div className="flex flex-col gap-[14px] px-[22px] py-[18px]">
        ...
        <SprProcessStatusSection variant={processVariant} managerApprovalDateLabel={managerApprovalDateLabel} />
