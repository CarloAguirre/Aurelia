...
// PLACEHOLDER: alerta de rango historico sin respaldo en backend (Figma 1395:4780).
export function SprHistoricalRangeAlert({ historicalRange, unitSymbol }: SprHistoricalRangeAlertProps) {
    ...
    <div className="flex flex-col gap-[8px] rounded-[9px] border-[1.5px] border-[#f5c4a0] bg-[#fff0e6] px-[14.5px] py-[12.5px]">
      <div className="flex items-start gap-[8px]">
        ...
        <div className="flex flex-col gap-[2px]">
          <p className="font-['Inter:Bold',sans-serif] text-[11.5px] font-bold text-[#e8720c]">Valor fuera del rango histórico habitual</p>
          <p className="font-['Inter:Regular',sans-serif] text-[10.5px] leading-[15.75px] text-[#6b3a1f]">
            AurelIA detectó que el valor ingresado difiere en más de un 10% respecto al promedio de los últimos 6 meses para
            este parámetro. Revisa el dato e indica el motivo de la diferencia en el campo de notas.
          </p>
        </div>
      </div>
