import { SPR_DATA_SOURCE_OPTIONS } from '../spr.constants';
...
export function SprParameterDetailForm({
  ...
  const { parameter, unitSymbol, needsHistoricalReview, historicalRange } = row;
    ...
    <div className="flex flex-col gap-[14px] px-[22px] py-[18px]">
      ...
      <label className="flex items-center gap-[8px] rounded-[8px] border border-[#e3e3e3] bg-[#f7f7f7] px-[13px] py-[10px]">
        ...
        <span className="flex flex-col">
          <span className="font-['Inter:Semi_Bold',sans-serif] text-[11px] font-semibold text-[#646464]">Sin consumo / No aplica en este período</span>
          <span className="font-['Inter:Regular',sans-serif] text-[9.5px] text-[#acacac]">Marcará el parámetro como &quot;No aplica&quot; sin valor numérico</span>
        </span>
      </label>
      ...
      <div className="flex flex-col gap-[5px]">
        {showHistoricalAlert ? (
          <p className="font-['Inter:Bold',sans-serif] text-[10px] font-bold text-[#131313]">
            Nota para el Gerente de Área <span className="text-[#e8720c]">— Explica el motivo de la diferencia</span>
          </p>
        ) : (
        ...
        <textarea
          ...
          placeholder={
            showHistoricalAlert
              ...
              : 'Agrega contexto, aclaraciones o referencias adicionales para facilitar la revisión…'
          }
        ...
        {showHistoricalAlert ? (
          <div className="flex items-center gap-[5px]">
            ...
            <p className="font-['Inter:Regular',sans-serif] text-[10px] text-[#e8720c]">
              Este campo queda registrado en la trazabilidad junto a la alerta detectada
            </p>
          </div>
        ) : null}
      </div>
