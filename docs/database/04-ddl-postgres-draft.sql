...
BEGIN
  FOREACH t IN ARRAY ARRAY[
    ...
    'inspection_checklist_templates','inspection_checklist_sections','inspection_checklist_items','inspections','inspection_checklist_answers','inspection_findings','inspection_followups',
    'incident_types','incidents','incident_involved_people','incident_immediate_actions','incident_flash_reports','incident_investigations','incident_peepo_analysis','incident_timeline_events','incident_five_why_items','incident_action_plans',
    'measurement_units','spr_measure_groups','spr_parameters','spr_monthly_records','spr_consolidation_rules',
